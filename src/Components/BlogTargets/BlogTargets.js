            ...
            <section className="block-content">
                ...
                <div className="d-flex-column gap-20">
                    <div className="blog-targets-buttons">
                        <button
                            type="button"
                            className="button-link button-link-2 blog-targets-button blog-targets-button-1"
                        ...
                        <button
                            type="button"
                            className="button-link button-link-2 blog-targets-button blog-targets-button-2"
                            onClick={scrollToEnd}
                        >
                            <span className="material-icons">chevron_right</span>
                        </button>
